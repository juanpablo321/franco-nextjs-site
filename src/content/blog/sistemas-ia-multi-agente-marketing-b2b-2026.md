...
keywords:
  ...
  - "multi-agent AI marketing"
  - "IA agéntica B2B"
  - "orquestación agentes IA"
...
| Característica | IA Generativa Tradicional (Ej. ChatGPT) | Sistema de IA Multi-Agente (MAS) |
| :--- | :--- | :--- |
| **Modo de Operación** | Reactivo (Responde a un prompt) | Proactivo (Planifica y ejecuta para un objetivo) |
| **Unidad de Trabajo** | Tarea única y aislada | Flujo de trabajo complejo y multi-paso |
| **Colaboración** | Nula (Opera en solitario) | Intrínseca (Agentes se comunican y coordinan) |
